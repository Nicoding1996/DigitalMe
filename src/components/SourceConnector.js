      ...
      <div className="relative z-10 w-full max-w-3xl mx-auto fade-in pb-8">
        ...
        <div className="mb-6">
          ...
          <p className="font-mono text-xs text-static-ghost leading-relaxed">
            <span className="text-unsettling-cyan">&gt;</span> [SYSTEM_NOTE] More content increases profile accuracy. Aim for 3,000+ words for optimal results. Sources can be added post-initialization via [SOURCES]
          </p>
        </div>
